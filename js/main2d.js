...
function init() {
	...
	frontTurret = new Turret(100,0,0,game.images.turretImage,0);
	rearTurret = new Turret(-100,0,0,game.images.turretImage,0);
	game.player1 = new Player(150,50,0,game.images.playerImage,0,frontTurret,rearTurret);
